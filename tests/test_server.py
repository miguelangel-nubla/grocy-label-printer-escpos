...
from grocy_label_printer_escpos.server import app, GrocyThermalServer
...
def test_extract_grocy_params_container_weight(thermal_server):
    """Test parameter extraction with container weight (should exclude amount/dates)"""
    data = {
        'product': 'Test Item',
        'grocycode': '123456',
        'stock_entry': {
        ...
        'stock_entry_userfields': {
            'StockEntryContainerWeight': '100.5'
        }
    }
