...
def test_image_endpoint_get(client: FlaskClient) -> None:
...
def test_image_endpoint_post(client: FlaskClient) -> None:
...
def test_print_endpoint_missing_data(client: FlaskClient) -> None:
...
def test_print_endpoint_success(mock_print: Mock, client: FlaskClient) -> None:
...
@patch("grocy_label_printer_escpos.server.GrocyThermalServer.print_label")
def test_print_endpoint_failure(mock_print: Mock, client: FlaskClient) -> None:
...
def test_extract_grocy_params(thermal_server: GrocyThermalServer) -> None:
...
def test_extract_grocy_params_container_weight(
...
def test_unit_name_singular_plural(thermal_server: GrocyThermalServer) -> None:
...
def test_create_qr_code(thermal_server: GrocyThermalServer) -> None:
...
def test_create_label_image(thermal_server: GrocyThermalServer) -> None:
...
def test_connect_printer_success(
    mock_network: Mock, thermal_server: GrocyThermalServer
) -> None:
...
@patch("grocy_label_printer_escpos.server.Network")
def test_connect_printer_failure(
    mock_network: Mock, thermal_server: GrocyThermalServer
) -> None:
